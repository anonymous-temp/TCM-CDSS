...
const SRC_MD = readFileSync(resolve(ROOT, "artifacts/证型标签待裁定清单-第二批.md"), "utf-8");
...
const md = [];
md.push("# 证型标签裁定结果·第二批（v4 pro max effort 初审 + 联网纠偏核验）");
md.push("");
...
const imp = {
  ...
  source: "ADJ-20260725-SYNDROME-TAG-B2:第二批 442 首,v4-pro max effort 初审 + 联网纠偏 + T1 确定性归一",
