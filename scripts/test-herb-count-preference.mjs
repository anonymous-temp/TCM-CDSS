...
check("HCP-07 流派：13 张受控卡片的 code 全部可直接作为入参", () => {
  assert.equal(LINEAGE_CARDS.length, 13, `流派卡片数变为 ${LINEAGE_CARDS.length}，需同步接口文档 §2.3.2 的表`);
...
check("HCP-10 文档与实现同源：接口文档必须列全 13 个流派 code 与 3 个味数取值", () => {
